        ...
        {groups.map((g, i) => (
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <h3 className="text-xl font-bold text-foreground transition-colors group-hover:text-brand-dark dark:text-neutral-100 dark:group-hover:text-brand-light">{g.title}</h3>
