  ...
  return (
    <div className="relative" ref={dropdownRef}>
      <button 
        ...
        className="flex h-10 items-center justify-between gap-3 min-w-[160px] rounded-full border border-border bg-card px-4 text-sm font-medium text-neutral-700 shadow-sm transition-all hover:bg-background dark:text-neutral-200 dark:hover:bg-neutral-800"
      >
      ...
      {isOpen && (
        <div className="absolute right-0 top-12 z-50 max-h-80 w-56 overflow-y-auto rounded-2xl border border-border bg-card p-2 shadow-xl animate-[fade-in-up_0.2s_ease-out] sm:left-0 sm:right-auto">
          {categories.length === 0 ? (
